import { FileCheck, Search, Download, Settings2, ChevronDown, ChevronUp } from "lucide-react";
...
const events = [
  ...
  { id: "4", timestamp: "2026-03-18 09:16:02", screen: "Lobby Screen 2", venue: "Westfield Sydney", campaign: "WU Brand Awareness", creative: "WU_Brand_16x9.mp4", scheduled: "09:16:00", actualStart: "09:16:03", actualEnd: "09:16:18", result: "Fill", reason: "Programmatic no-fill fallback" },
  { id: "5", timestamp: "2026-03-18 09:17:15", screen: "Food Court Screen 3", venue: "Melbourne Central", campaign: "Coca-Cola Summer", creative: "CocaCola_15s_V2.mp4", scheduled: "09:17:00", actualStart: "09:17:15", actualEnd: "09:17:30", result: "Played", reason: "—" },
  { id: "6", timestamp: "2026-03-18 09:18:00", screen: "Elevator Panel 1", venue: "Brisbane CBD Tower", campaign: "Nike Spring", creative: "Nike_Logo_Static.jpg", scheduled: "09:18:00", actualStart: "—", actualEnd: "—", result: "Skipped", reason: "Frequency cap reached" },
  { id: "7", timestamp: "2026-03-18 09:19:30", screen: "Parking Totem 1", venue: "Perth Arena", campaign: "WU Brand Awareness", creative: "WU_Brand_16x9.mp4", scheduled: "09:19:30", actualStart: "09:19:30", actualEnd: "09:19:45", result: "Failed", reason: "Playback timeout" },
];

const resultFilters = ["All", "Played", "Fill", "Skipped", "Failed", "No Fill"];
...
export default function ProofOfPlay() {
  ...
  const [includeFill, setIncludeFill] = useState(true);
    ...
    <div>
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            <Button variant="outline" size="sm"><Download size={14} className="mr-1" /> Export {exportFormat.toUpperCase()}</Button>
            <Button
              variant="outline"
              size="sm"
              onClick={() => setShowExportSettings((s) => !s)}
              className={showExportSettings ? "border-primary text-primary" : ""}
            >
              <Settings2 size={14} className="mr-1" />
              Export Settings
              {showExportSettings ? <ChevronUp size={12} className="ml-1" /> : <ChevronDown size={12} className="ml-1" />}
            </Button>
          </div>
        }
      />
      ...
      <div className="p-8 space-y-4">
        ...
        {showExportSettings && (
          <div className="skoop-card p-5 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="flex items-center justify-between col-span-2 gap-8">
                <div className="flex items-center justify-between flex-1">
                  <div>
                    <p className="text-sm font-medium">Scheduled daily export</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Automatically export PoP data every day</p>
                  </div>
                  <Switch checked={scheduledExport} onCheckedChange={setScheduledExport} />
                </div>
                <div className="flex items-center justify-between flex-1">
                  <div>
                    <p className="text-sm font-medium">Include fill events</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Include house fill and in-house content plays</p>
                  </div>
                  <Switch checked={includeFill} onCheckedChange={setIncludeFill} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Input type="date" className="w-36 h-9 text-sm" />
          <Select>
            <SelectTrigger className="w-44 h-9 text-sm"><SelectValue placeholder="All campaigns" /></SelectTrigger>
            <SelectContent>
              <SelectItem value="all">All campaigns</SelectItem>
              <SelectItem value="nike">Nike Spring</SelectItem>
              <SelectItem value="coca">Coca-Cola Summer</SelectItem>
              <SelectItem value="wu">WU Brand Awareness</SelectItem>
            </SelectContent>
          </Select>
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              {Object.entries({
                ...
                Creative: drawer.creative,
                Scheduled: drawer.scheduled,
                "Actual Start": drawer.actualStart,
                "Actual End": drawer.actualEnd,
