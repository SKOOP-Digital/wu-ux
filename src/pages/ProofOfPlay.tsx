...
const events = [
  { id: "1", timestamp: "2026-04-18 09:15:22", screen: "Lobby Screen 1", venue: "Westfield Sydney", campaign: "Nike Spring", rule: "Financial Banks · Northeast", creative: "Nike_Summer_16x9.mp4", scheduled: "09:15:00", actualStart: "09:15:02", actualEnd: "09:15:17", result: "Played", reason: "—" },
  { id: "2", timestamp: "2026-04-18 09:15:37", screen: "Lobby Screen 1", venue: "Westfield Sydney", campaign: "Programmatic", rule: "Financial Banks · Northeast", creative: "AdX_Creative_4821", scheduled: "09:15:15", actualStart: "09:15:37", actualEnd: "09:15:47", result: "Played", reason: "—" },
  { id: "3", timestamp: "2026-04-18 09:16:02", screen: "Lobby Screen 2", venue: "Westfield Sydney", campaign: "Programmatic", rule: "Financial Banks · Northeast", creative: "—", scheduled: "09:16:00", actualStart: "—", actualEnd: "—", result: "No Fill", reason: "No bid received" },
  { id: "4", timestamp: "2026-04-18 09:16:03", screen: "Lobby Screen 2", venue: "Westfield Sydney", campaign: "WU Brand Awareness", rule: "Financial Banks · Northeast", creative: "WU_Brand_16x9.mp4", scheduled: "09:16:00", actualStart: "09:16:03", actualEnd: "09:16:18", result: "Backfilled", reason: "Programmatic no-fill fallback" },
  { id: "5", timestamp: "2026-04-18 09:17:15", screen: "Food Court Screen 3", venue: "Melbourne Central", campaign: "Pepsi Q2 Push", rule: "Urban Panels · National", creative: "Pepsi_Q2_16x9.mp4", scheduled: "09:17:00", actualStart: "09:17:15", actualEnd: "09:17:30", result: "Played", reason: "—" },
  { id: "6", timestamp: "2026-04-18 09:18:00", screen: "Elevator Panel 1", venue: "Brisbane CBD Tower", campaign: "Nike Spring", rule: "Financial Banks · Northeast", creative: "Nike_Logo_Static.jpg", scheduled: "09:18:00", actualStart: "—", actualEnd: "—", result: "Skipped", reason: "Frequency cap reached" },
  { id: "7", timestamp: "2026-04-18 09:19:30", screen: "Parking Totem 1", venue: "Perth Arena", campaign: "WU Brand Awareness", rule: "Pharmacies · National", creative: "WU_Brand_16x9.mp4", scheduled: "09:19:30", actualStart: "09:19:30", actualEnd: "09:19:45", result: "Failed", reason: "Playback timeout" },
];
          ...
          <table className="w-full">
            <thead>
              <tr className="skoop-table-header">
                ...
                <th className="skoop-table-cell text-left">Rule</th>
            ...
            <tbody>
              {filtered.map((e) => (
                <tr key={e.id} className="skoop-table-row cursor-pointer" onClick={() => setDrawer(e)}>
                  ...
                  <td className="skoop-table-cell text-xs text-muted-foreground">{e.rule}</td>
        ...
        {drawer && (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              {Object.entries({ Timestamp: drawer.timestamp, Screen: drawer.screen, Venue: drawer.venue, Campaign: drawer.campaign, Rule: drawer.rule, Creative: drawer.creative, Scheduled: drawer.scheduled, "Actual Start": drawer.actualStart, "Actual End": drawer.actualEnd, Reason: drawer.reason }).map(([k, v]) => (
