              ...
              <div className="skoop-card p-5 space-y-5">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>Owned</span>
                      <span className="tabular-nums font-medium">{owned}% · {Math.round(capacity.total * owned / 100).toLocaleString()} playback opportunities/day</span>
                    </div>
                    <Slider value={[owned]} onValueChange={([v]) => { if (v + direct <= 100) setOwned(v); }} max={100} step={5} className="[&_[role=slider]]:bg-skoop-slate" />
                  </div>
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>Direct</span>
                      <span className="tabular-nums font-medium">{direct}% · {Math.round(capacity.total * direct / 100).toLocaleString()} playback opportunities/day</span>
                    </div>
                    <Slider value={[direct]} onValueChange={([v]) => { if (owned + v <= 100) setDirect(v); }} max={100} step={5} className="[&_[role=slider]]:bg-skoop-blue" />
                  </div>
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>Programmatic</span>
                      <span className="tabular-nums font-medium">{Math.max(0, prog)}% · {Math.round(capacity.total * Math.max(0, prog) / 100).toLocaleString()} playback opportunities/day</span>
                    </div>
                    <div className="h-2 rounded-full bg-secondary overflow-hidden">
                      <div className="h-full bg-skoop-purple rounded-full transition-all" style={{ width: `${Math.max(0, prog)}%` }} />
                    </div>
                ...
                {editingRules ? (
                  <div className="space-y-3">
                    <div className="skoop-card p-4 space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium">Category Separation</p>
                          <p className="text-xs text-muted-foreground mt-0.5">Prevent competing brands from appearing in the same loop</p>
                        </div>
                        <Switch checked={catSeparation} onCheckedChange={setCatSeparation} />
                      </div>
                      {catSeparation && (
                        <div className="flex items-center gap-2 pl-1">
                          <span className="text-xs text-muted-foreground">Slot gap:</span>
                          <select
                            value={catSeparationGap}
                            onChange={(e) => setCatSeparationGap(Number(e.target.value))}
                    ...
                    <div className="skoop-card p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium">Back-to-back Prevention</p>
                          <p className="text-xs text-muted-foreground mt-0.5">Same creative cannot play consecutively</p>
                        </div>
                        <Switch checked={backToBack} onCheckedChange={setBackToBack} />
                      </div>
                    ...
                    <div className="skoop-card p-4 space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium">Frequency Cap</p>
                          <p className="text-xs text-muted-foreground mt-0.5">Maximum plays per unique creative per hour</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <select
        ...
        {section === "Active Campaigns" && (
          <div className="space-y-6">
            ...
            {activeCampaigns.length === 0 ? (
              <div className="skoop-card border border-dashed border-border rounded-lg py-12 text-center">
              ...
              <>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="skoop-card p-4">
                    ...
                    <p className="text-lg font-semibold tabular-nums">{directCap.toLocaleString()} playback opportunities/day</p>
                  ...
                  <div className="skoop-card p-4">
                    ...
                    <p className="text-lg font-semibold tabular-nums">{progCap.toLocaleString()} playback opportunities/day</p>
                  ...
                  <div className="skoop-card p-4">
                    ...
                    <p className="text-lg font-semibold tabular-nums">{ownedCap.toLocaleString()} playback opportunities/day</p>
